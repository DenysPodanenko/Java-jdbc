...
//
//
//// todo DAO.OrderDAO, interface DAO<T>
//public class DAO {
//    DAO() {
...
//            String SQL = "SELECT * FROM dbo.Model.Client";
...
//
//        try (Connection con = DriverManager.getConnection(connection); Statement stmt = con.createStatement();) {
//            String SQL = "SELECT * FROM dbo.[Model.Order]";
//            ResultSet rs = stmt.executeQuery(SQL);
//
//            while (rs.next()) {
...
//
//        try (Connection con = DriverManager.getConnection(connection); Statement stmt = con.createStatement();) {
//            String SQL = "SELECT * FROM dbo.Model.Tour";
//            ResultSet rs = stmt.executeQuery(SQL);
//
//            while (rs.next()) {
...
//
//        try (Connection con = DriverManager.getConnection(connection); Statement stmt = con.createStatement();) {
//            String SQL = "SELECT * FROM dbo.Model.Hotel";
//            ResultSet rs = stmt.executeQuery(SQL);
//
//            while (rs.next()) {
...
//        try (Connection con = DriverManager.getConnection(connection); Statement stmt = con.createStatement();) {
//            String SQL = String.format("INSERT INTO dbo.Model.Client VALUES (%d, '%s', '%s', '%s', '%s', '%s', %d)",
