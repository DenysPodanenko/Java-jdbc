...
//            System.out.println(String.format("id:%d; Date:%s; Model.Client:%s %s; Model.Tour:%s",
...
//            System.out.println(String.format("id:%s, Name:%s; Description:%s; Model.Hotel:%s; Price:%d; Rating:%d",
...
//            System.out.println(String.format("id:%d; Date:%s; Model.Client:%s %s;",
...
//        System.out.println(String.format("\n----Tours for Model.Hotel '%s'----", db.getHotelById(hotelId).getName()));
